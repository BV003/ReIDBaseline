...
for t in range(10):
    ...
    for r in a1:
        for img in photo_imgs:
            ...
            if int(id)==r:
                path3.write('photo/'+img.split('/')[-1]+' '+ id + ' '+ camid + '\n')
        for ske in sketch_imgs:
            id = (ske.split('/')[-1]).split('.')[0]
            camid = '0'
            # camid = (img.split('/')[-1]).split('_')[1]
            if int(id)==r:
                path4.write('sketch/'+ske.split('/')[-1]+' '+ id + ' '+ camid + '\n')
    ...
    for r in a2:
        for img in photo_imgs:
            ...
            camid = (img.split('/')[-1]).split('_')[1]
            if int(id)==r:
                path1.write('photo/' + img.split('/')[-1] + ' ' + id + ' ' + camid + '\n')
        for ske in sketch_imgs:
            id = (ske.split('/')[-1]).split('.')[0]
            camid = '0'
            # camid = (img.split('/')[-1]).split('_')[1]
            if int(id)==r:
                path2.write('sketch/' + ske.split('/')[-1] + ' ' + id + ' ' + camid + '\n')
